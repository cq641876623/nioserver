...
/**
 * @author chenqi
 * @date 2021-02-09 16:03
 */
public class ClassScanner {

    public static void main(String[] args) throws IOException, ClassNotFoundException {
        Predicate<String> packagePredicate = s -> true;
        ClassScanner classScanner=new ClassScanner("com.cq.nio.server",true,packagePredicate, null);
        Set<Class<?>> packageAllClasses = classScanner.doScanAllClasses();
        packageAllClasses.forEach(it -> {
            System.out.println(it.getName());

            System.out.println(it.getMethods().length);
        });
    }
